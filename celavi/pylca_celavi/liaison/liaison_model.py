...
def main_run(lca_project,updated_project_name,year_of_study,results_filename,mc_foreground_flag,lca_flag,region_sensitivity_flag,edit_ecoinvent_user_controlled,region,data_dir,input_dir,primary_process,process_under_study,location_under_study,unit_under_study,updated_database,mc_runs,functional_unit,inventory_filename,pv_module_chars,output_dir,bw):
    ...
    def lca_runner(db,r,mc_runs,mc_foreground_flag,lca_flag,functional_unit,run_filename):
            ...
            searched_item = search_activity_in_ecoinvent(process_dictionary,process_under_study,location_under_study,unit_under_study,run_filename)
            ...
            if type(searched_item) == str:
                ...
                functional_unit =  module_disassembly_glass_content(process_under_study,year_of_study,functional_unit,pv_module_chars)
                ...
                if edit_ecoinvent_user_controlled  == True:  
                    ...
                    functional_unit = module_required_for_solar_glass(inventory,year_of_study,functional_unit,pv_module_chars)

                    #Editing the functional unit for solar module installation
                    functional_unit = module_installation_for_solar_glass(inventory,year_of_study,functional_unit,pv_module_chars)
