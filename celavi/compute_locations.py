...
class ComputeLocations:
    ...
    def __init__(self,
        ...
        power_plant_locations : str
            Filename of data set of renewable energy power plant locations including lat,
            long, region identifier columns, and other power-plant-specific
            information as needed.
        
        commercial_building_locations : str
            Filename of commercial building locations and window installations 
            over time, derived from Comstock data for 2000-2018 new construction.

        landfill_locations : str
            Filename of data set of landfill locations, from EPA's LMOP database.

        other_facility_locations : str
            Filename of data set of all other facility types involved in the case study.
            This dataset is the only manually created dataset of facility locations.
        
        state_centroids : str
            Filename of dataset of all U.S. state centroids, for use when facilities don't
            have exact locations.

        transportation_graph : str
            Filename to transportation network (U.S. roads) data.

        node_locations : str
            Filename to node locations within transportation graph (road intersections).

        lookup_facility_type : str
            Filename to list of allowable facility types in the case study.

        technology_data_filename : str
            Filename where technology-specific installation data, including year
            installed, location (lat, long, and region identifiers), and any
            technology-specific data required to model material flows into
            power plants, is saved after being generated by this class.

        standard_scenarios_filename : str
            Filename of output data from NREL's ReEDS model, used for capacity expansion
            projections of renewable electricity technologies past the current year.
        
        market_share_filename : str
            Filename of data (time series) giving the market share of c-Si PV modules
            installed - other module types like thin film or CdTe are not included.
            This information is applied to the ReEDS outputs.

        pv_module_chars_filename : str
            Filename of dataset defining how much solar glass is used per individual
            module, from NREL's PV ICE.
        """
    ...
    def solar_power_plant(self):
        ...
        # (only have road network data for the contiguous United States, and do not
        # have landfill data for Washington DC)
        pv_locs.drop(
    ...
    def commercial_building_windows(self):
        """
        Ingests a modified dataset based on Comstock new building projections,
        ...
        See CommWindowUnitLocations child class of Data class for column names and
        data types.
        ...
        Returns
        -------
        building_locs_state : pd.DataFrame
            Dataset of commercial building locations (aggregated to state centroids)
            ...
            Columns:
                ...
                - region_id_4 : str
        """
       # Process data from Comstock outputs
    ...
    def capacity_projections_solar(self):
        """
        Use NREL's ReEDS Standard Scenarios output for electricity grid mix projections to
        calculate future technology unit installations. See the StandardScenarios
        child class of the Data parent class for additional information on
        obtaining and formatting the input dataset.
        ...
        None
        """
        # Read in data on c-Si module market share over time
        # This is used to decrease PV installation projections from ReEDs, which
        # combine c-Si with other module technologies not modeled in the glass
        # case study
