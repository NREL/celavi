...
def remanufacture_process_learning():
    ...
    Original Eqn: b'remanufacture learning rate * TREND(Cumulative Remanufacture, 0.5 , 0 ) * MAX(0, Remanufacture Process Cost\\\\ ) / one Year'
    Units: b'USD/metric ton/year'
    Limits: (None, None)
    Type: component
    ...
    """
    return remanufacture_learning_rate() * _trend_cumulative_remanufacture_05_0() * np.maximum(
        0, remanufacture_process_cost()) / one_year()
...
def recycle_process_learning():
    ...
    Original Eqn: b'recycle learning rate * TREND(Cumulative Recycle, 0.5 , 0 ) * MAX(0, Recycle Process Cost\\\\ ) / one Year'
    Units: b'USD/metric ton/year'
    Limits: (None, None)
    Type: component
    ...
    """
    return recycle_learning_rate() * _trend_cumulative_recycle_05_0() * np.maximum(
        0, recycle_process_cost()) / one_year()
...
def reuse_process_learning():
    ...
    Original Eqn: b'-reuse learning rate * TREND(Cumulative Reuse, 0.5 , 0 ) * MAX(0, Reuse Process Cost\\\\ ) / one Year'
    Units: b'USD/metric ton/year'
    Limits: (None, None)
    Type: component
